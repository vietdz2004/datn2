          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1" fontWeight="medium">
                {user?.vaiTro === 'KHACH_HANG' ? 'Khách hàng' : user?.vaiTro || 'Không xác định'}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1" fontWeight="medium" color="success.main">
                {user?.trangThai === 'HOAT_DONG' ? 'Đang hoạt động' : user?.trangThai || 'Không xác định'}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1" fontWeight="medium">
                {user?.ngayCapNhat || user?.updatedAt ? 
                  new Date(user.ngayCapNhat || user.updatedAt).toLocaleDateString('vi-VN', { 
                    year: 'numeric', 
                    month: 'long', 
                    day: 'numeric',
                    hour: '2-digit',
